...
/**
 * Created by Irina on 16.09.2016.
 */
...
public class Main {
    ...
    public static void multiply(int[][] a, int[][] b)
    {
        ...
        System.out.println("Произведение матриц А и В простым методом: ");
        System.out.println();
        for(i=0;i<a.length;i++)
        {
            for(j =0; j<a.length;j++)
    ...
    public static void main(String[] args) {
        ...
        arr = strassen(a,b);
        System.out.println("Произведение матриц А и В методом Штрассена: ");
        print(arr);
        multiply(a,b);
